...
export class PacienteService extends GenericService<Paciente>{
  ...
  private pacienteActualCambio: Subject<Paciente> = new Subject<Paciente>();
 ...
 /* listar() {
  ...
  getPacienteActualCambio(){
    return this.pacienteActualCambio.asObservable();
  }

  setPacienteActualCambio(paciente: Paciente) {
    this.pacienteActualCambio.next(paciente);
  }
